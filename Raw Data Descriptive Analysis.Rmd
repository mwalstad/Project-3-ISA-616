...
```{r}
data = read_excel("C:/Users/Max/Downloads/raw data 616 project 3/Thematic Sequence.xlsx")
print(data)
```
```{r}
...
```{r}
data2 = read_excel("C:/Users/Max/Downloads/raw data 616 project 3/BA Minors.xlsx")
print(data2)
```
```{r}
...
```{r}
data3 = read_excel("C:/Users/Max/Downloads/raw data 616 project 3/IS Minors.xlsx")
print(data3)
```
```{r}
...
```{r}
data4 = read_excel("C:/Users/Max/Downloads/raw data 616 project 3/IS2 Minors.xlsx")
print(data4)
```
...
```{r}
data5 = read_excel("C:/Users/Max/Downloads/raw data 616 project 3/MIT Minors.xlsx")
print(data5)
```
