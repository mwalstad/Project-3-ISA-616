...
students stay with the business analytics major?

In this document, we analyzed data from Miami University's Farmer School
of Business student data from fall 2018 to fall 2023 school years,
...
Minor, and ISA2 thematic sequence. We used a random forest model to
...
our analysis of answering the research questions above.
...
-   Time series analysis and prediction of future enrollment for the
...
We created two final files One tables is the merged student information
...
2018 to fall 2024. We intend on adding to each bar chart the % growth
each semester and a line of best fit. Plotting the line of best fit will
return a prediction for a future semester.We also intend on continuing
to improve the aesthetics and understandably of each graph with better
...
202420 and 202510, with a naive forecast. The most recent four semesters
...
We conducted a time series analysis on the business analytics major
...
enrollment are very similar. We used a naive forecast for 202420 to
continue this pattern determining that the projected enrollment in the
...
[Link to trained model](616model.html){:target="\_blank"}

inert Explanation of Model here
...
guide](616implementation.html){:target="\_blank"}
